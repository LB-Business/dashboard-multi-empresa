...
import { Search, UserCircle, MoreHorizontal, Users } from "lucide-react";
    ...
    <div>
      ...
      <div className="p-6 space-y-4">
        ...
        {isLoading ? (
          ...
          <EmptyState icon={Users} title="Sin usuarios" description="No hay usuarios registrados en la plataforma." />
        ) : (
              ...
              <tbody className="divide-y divide-border">
                {filtered.map((user) => (
                  <tr key={user._id} className="hover:bg-muted/20 transition-colors">
                    ...
                    <td className="px-4 py-3 text-muted-foreground hidden lg:table-cell">{user.business?.name || "-"}</td>
                    <td className="px-4 py-3">
